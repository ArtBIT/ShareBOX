...
/*
// Make these methods available to loggedin users
$config['auth_override_class_method']['merenja']['tacke'] = 'session';
$config['auth_override_class_method']['merenja']['redovi'] = 'session';
$config['auth_override_class_method']['grupe']['index'] = 'session';
$config['auth_override_class_method']['grupe']['korisnici'] = 'session';
$config['auth_override_class_method']['korisnici']['autocomplete'] = 'session';
$config['auth_override_class_method']['korisnici']['index'] = 'session';
*/
