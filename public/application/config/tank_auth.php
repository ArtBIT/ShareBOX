...
|--------------------------------------------------------------------------
*/
$config['website_name']    = SHAREBOX_WEBSITE_NAME;
$config['webmaster_email'] = SHAREBOX_WEBMASTER_EMAIL;
...
$config['recaptcha_public_key']  = SHAREBOX_RECAPTCHA_PUBLIC_KEY;
$config['recaptcha_private_key'] = SHAREBOX_RECAPTCHA_PRIVATE_KEY;
